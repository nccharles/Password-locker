...
class TestUser(unittest.TestCase):
	...
	def test__init__(self):
		...
		self.assertEqual(self.new_user.last_name,'Ndayisaba')
		self.assertEqual(self.new_user.password,'ps123')
...
class TestCredentials(unittest.TestCase):
	...
	def setUp(self):
		...
		'''
		self.new_credential = Credential('Charles','Facebook','nccharles','ps123')
